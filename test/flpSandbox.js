		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#apadaniprogrameventcalculator-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"apadaniprogrameventcalculator-display": {
								"semanticObject": "apadaniprogrameventcalculator",
								"action": "display",
								"description": "Events",
								"title": "Surprise Events",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=apa.dani.program.eventcalculator",
									"url": sap.ui.require.toUrl("apa/dani/program/eventcalculator")
								}
							}
						}
					}
